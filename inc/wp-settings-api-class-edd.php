...
if ( ! class_exists( 'WP_Settings_API_Class2_Edd' ) ):
	class WP_Settings_API_Class2_Edd {
		...
		function callback_select_product_checklist( $args ) {
			...
			add_filter( 'wpsapi_checklist_name', array( $this, 'select_category_checklist_name' ) );
			add_filter( 'wpsapi_checklist_taxonomy', array( $this, 'wpsapi_checklist_taxonomy_download_category' ) );
			...
			remove_filter( 'wpsapi_checklist_name', 'select_category_checklist_name' );
			remove_filter( 'wpsapi_checklist_taxonomy', 'wpsapi_checklist_taxonomy_download_category' );
		...
		function wpsapi_checklist_taxonomy_download_category() {
